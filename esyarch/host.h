...
#ifndef HOST_H
#define HOST_H
/*debug for c2cpp [format]-- lch*/
const char dbg_c1[] = "%12d";
const char dbg_c2[] = "%d";
const char dbg_c3[] = "%12u";
const char dbg_c4[] = "%u";
const char dbg_c5[] = "%12.4f";
const char dbg_c6[] = "%.4f";
const char dbg_c7[] = "%12s";
const char dbg_c8[] = "%s";
const char dbg_c9[] = "%12lu";
const char dbg_c10[] = "%12ld";

...
extern double SIM_array_dec_report(unsigned long long sim_cycle, SIM_power_dec_t *dec, int telem);
extern double SIM_array_wordline_report(unsigned long long sim_cycle, SIM_power_wordline_t *wordline, int telem);
extern double SIM_array_bitline_report(unsigned long long sim_cycle, SIM_power_bitline_t *bitline, int telem);
extern double SIM_array_amp_report(unsigned long long sim_cycle, SIM_power_amp_t *amp, int telem);
extern double SIM_array_comp_report(unsigned long long sim_cycle, SIM_power_comp_t *comp, int telem);
extern double SIM_array_mux_report(unsigned long long sim_cycle, SIM_power_mux_t *mux, int telem);
extern double SIM_array_outdrv_report(unsigned long long sim_cycle, SIM_power_out_t *outdrv, int telem);
extern double SIM_array_mem_report(unsigned long long sim_cycle, SIM_power_mem_t *mem, int telem);
extern double SIM_array_pre_report(unsigned long long sim_cycle, SIM_power_arr_pre_t *pre, int telem);

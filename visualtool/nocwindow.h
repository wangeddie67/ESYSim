...
public:
     ...
     */
    enum EventCode {
        FT_NETWORK_NEW    = 0,    /*!< create new network file */
        FT_NETWORK_OPEN   = 1,    /*!< open network file */
        FT_NETWORK_SAVE   = 2,    /*!< save network file */
        FT_NETWORK_SAVEAS = 3,    /*!< save network file as new file */
        FT_NETWORK_CLOSE  = 4,    /*!< close network file */
        FT_TOOLS_NETWORK_CONFIG       = 10,    /*!< network configuration */

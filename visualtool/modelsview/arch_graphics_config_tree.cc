...
{
    clear();
	GraphicsConfigModelItem * component_item = new GraphicsConfigModelItem();
	component_item->setItem( "Component" );
	appendItem( component_item );
	component_item->appendItem( new GraphicsConfigModelItem( "Component", "Normal",
        Qt::black, 1, Qt::SolidLine, Qt::white, Qt::SolidPattern ) );
	component_item->appendItem( new GraphicsConfigModelItem( "Component", "Selected",
        Qt::black, 3, Qt::SolidLine, Qt::white, Qt::SolidPattern ) );

	GraphicsConfigModelItem * light_item = new GraphicsConfigModelItem();
	light_item->setItem( "Light" );
	appendItem( light_item );
	light_item->appendItem( new GraphicsConfigModelItem( "Light", "Empty",
		Qt::black, 1, Qt::SolidLine, Qt::white, Qt::SolidPattern ) );
	light_item->appendItem( new GraphicsConfigModelItem( "Light", "Hit",
		Qt::black, 1, Qt::SolidLine, Qt::green, Qt::SolidPattern ) );
	light_item->appendItem( new GraphicsConfigModelItem( "Light", "Miss",
		Qt::black, 1, Qt::SolidLine, Qt::red, Qt::SolidPattern ) );

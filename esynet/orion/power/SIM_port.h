...
#define PARM_crossbar_in_len	610		/* crossbar input line length, if known */
#define PARM_crossbar_out_len	2440		/* crossbar output line length, if known */

/* input buffer parameters */
#define PARM_in_buf		1	/* have input buffer? */
#define PARM_in_buf_set		128	/* # of rows */
#define PARM_in_buf_rport	1	/* # of read ports */

#define PARM_cache_in_buf	1
#define PARM_cache_in_buf_set	128

...
double SIM_power_decoder_delay(int C, int B, int A, int Ndwl, int Ndbl, int Nspd,  int Ntwl, int Ntbl, int Ntspd, double * Tdecdrive,
...
double SIM_power_decoder_tag_delay(int C, int B, int A, int Ndwl, int Ndbl, int Nspd, int Ntwl, int Ntbl, int Ntspd,
...
double SIM_power_wordline_delay(int B, int A, int Ndwl, int Nspd, double inrisetime, double *outrisetime)
//int B,A,Ndwl,Nspd;
//double inrisetime,*outrisetime;
{
        double Rpdrive;//,nextrisetime;
        double desiredrisetime,psize,nsize;
        double tf,nextinputtime,Ceq,Rline,Cline;//,Req
        int cols;
...
double SIM_power_wordline_tag_delay(int C, int A, int Ntspd, int Ntwl, double inrisetime, double *outrisetime)
//int C,A,Ntspd,Ntwl;
//double *outrisetime;
//double inrisetime;
{
...
double SIM_power_bitline_delay(int C, int A, int B, int Ndwl, int Ndbl, int Nspd, double inrisetime, double *outrisetime)
//int C,A,B,Ndbl,Nspd;
//double inrisetime,*outrisetime;
{
...
double SIM_power_bitline_tag_delay(int C, int A, int B, int Ntwl, int Ntbl, int Ntspd, double inrisetime, double *outrisetime)
...
/* It is assumed the sense amps have a constant delay
   (see section 6.5) */
double SIM_power_sense_amp_delay(double inrisetime,double *outrisetime)
//double inrisetime,*outrisetime;
{
...
double SIM_power_sense_amp_tag_delay(double inrisetime, double *outrisetime)
//double inrisetime,*outrisetime;
{
...
double SIM_power_compare_time(int C, int A, int Ntbl, int Ntspd, double inputtime, double *outputtime)
//int C,A,Ntbl,Ntspd;
...
double SIM_power_mux_driver_delay(int C,int B,int A,int Ndbl,int Nspd,int Ndwl,int Ntbl,int Ntspd, double inputtime, double *outputtime)
...
double SIM_power_valid_driver_delay(int C, int A, int Ntbl,int Ntspd, double inputtime)
//int C,A,Ntbl,Ntspd;
//double inputtime;
{
   double Ceq,Tst1,tf;
...
double SIM_power_dataoutput_delay(int C, int B, int A, int Ndbl, int Nspd, int Ndwl,
...
double SIM_power_selb_delay_tag_path(double inrisetime, double *outrisetime)
//double inrisetime,*outrisetime;
{
   double Ceq,Tst1,tf;
 ...
 */
double SIM_power_precharge_delay(double worddata)
//double worddata;
{
...
int SIM_power_organizational_parameters_valid(int rows, int cols, int Ndwl, int Ndbl, int Nspd, int Ntwl, int Ntbl, int Ntspd)
...
void SIM_power_calculate_time(time_result_type *result, time_parameter_type *parameters)
...
//time_parameter_type *parameters;
{
   ...
   double time_till_compare,time_till_select,valid_driver;//,driver_cap

...
extern int SIM_power_array_data_write( SIM_power_array_info_t *info, SIM_power_array_t *arr, SIM_array_set_state_t *set, u_int n_item, char *data_line, char *old_data, char *new_data );
extern int SIM_power_array_tag_read( SIM_power_array_info_t *info, SIM_power_array_t *arr, SIM_array_set_state_t *set );
extern int SIM_power_array_tag_update( SIM_power_array_info_t *info, SIM_power_array_t *arr, SIM_array_port_state_t *port, SIM_array_set_state_t *set );
extern int SIM_power_array_tag_compare( SIM_power_array_info_t *info, SIM_power_array_t *arr, SIM_array_port_state_t *port, LIB_Type_max_uint tag_input, LIB_Type_max_uint col_addr, SIM_array_set_state_t *set );
...
extern int SIM_array_set_state_init( SIM_power_array_info_t *info, SIM_array_set_state_t *set );

extern int SIM_array_power_init( SIM_power_array_info_t *info, SIM_power_array_t *arr );
extern double SIM_array_power_report( SIM_power_array_info_t *info, SIM_power_array_t *arr, int telem );
extern double SIM_Array_Power_Report( SIM_power_array_info_t *info, SIM_power_array_t *arr );

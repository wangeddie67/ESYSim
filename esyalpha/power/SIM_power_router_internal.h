...
extern double SIM_crossbar_report(SIM_power_crossbar_t *crsbar, int telem);
extern double SIM_Crossbar_Report(SIM_power_crossbar_t *crsbar);
...
extern double SIM_arbiter_report(SIM_power_arbiter_t *arb, int telem);
extern double SIM_Arbiter_Report(SIM_power_arbiter_t *arb);
